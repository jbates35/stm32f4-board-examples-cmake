...
int main(void) {
  ...
  USARTInterruptConfig_t usart_int_setup_cfg = {.error_interrupts_en = USART_DISABLE,
                                                .idle_en = USART_DISABLE,
                                                .tx_complete_en = USART_DISABLE,
                                                .tx = {.en = USART_ENABLE,
                                                       .buff = tx_buff,
                                                       .len = tx_len,
                                                       .tx_circular_en = USART_DISABLE,
                                                       .callback = tx_callback},
                                                .rx = {.en = USART_ENABLE,
                                                       .buff = rx_buff,
                                                       .len = rx_len,
                                                       .rx_length_byte_en = USART_DISABLE,
                                                       .rx_ignore_escapes = USART_ACCEPT_ESCAPE_CHARS,
